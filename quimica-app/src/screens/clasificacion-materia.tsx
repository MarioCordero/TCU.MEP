...
interface ClasificacionMateriaProps {
  onBack: () => void
}

export default function ClasificacionMateria({ onBack }: ClasificacionMateriaProps) {
  return (
      ...
      <nav className="bg-gradient-to-r from-blue-700 to-blue-800 text-white p-4 shadow-lg sticky top-0 z-10">
        <div className="container mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Button variant="ghost" size="icon" className="text-white hover:bg-blue-600" onClick={onBack}>
