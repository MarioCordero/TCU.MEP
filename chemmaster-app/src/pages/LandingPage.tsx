...
// Import the grade pages and CMS
...
// Main App Wrapper with Progress Provider
...
function ChemistryAppContent() {
  ...
  if (currentPage === "grade-10") {
    return <GradeTenPage onBack={() => setCurrentPage("grade-selector")} />
  }

  if (currentPage === "grade-11") {
    return <GradeElevenPage onBack={() => setCurrentPage("grade-selector")} />
  }
  ...
  if (currentPage === "cms") {
    ...
    // return <CMSPage onClose={() => { setIsCmsAuthenticated(false); setCurrentPage("landing") }} />
    return null
  }
...
const externalResources = [
  ...
  },
  {
    id: "chemcollective",
    name: "ChemCollective",
    description: "Laboratorios virtuales donde puedes realizar experimentos de quimica sin riesgos.",
    longDescription: "Realiza experimentos de laboratorio virtuales. Mezcla reactivos, mide pH, realiza titulaciones de forma segura.",
    url: "http://chemcollective.org/vlabs",
    icon: FlaskConical,
    color: "from-orange-500 to-amber-600",
    category: "Laboratorio Virtual",
    tags: ["Experimentos", "Seguro", "Practico"],
  },
  {
    id: "chemtube3d",
    name: "ChemTube3D",
    description: "Animaciones 3D de mecanismos de reaccion y estructuras moleculares organicas.",
    longDescription: "Visualiza mecanismos de reacciones organicas paso a paso en 3D. Ideal para entender como ocurren las reacciones.",
    url: "https://www.chemtube3d.com",
    icon: Microscope,
    color: "from-pink-500 to-rose-600",
    category: "Quimica Organica",
    tags: ["Mecanismos", "Organica", "3D"],
  },
  {
    id: "quimitube",
    name: "Quimitube",
        ...
        <div className="container mx-auto px-4 py-3 md:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-3">
                <motion.div animate={{ rotate: [0, 10, -10, 0] }} transition={{ duration: 2, repeat: Infinity }} className="p-2 bg-gradient-to-r from-cyan-500 to-violet-600 rounded-xl">
                  <Compass className="h-5 w-5 md:h-6 md:w-6 text-white" />
                </motion.div>
                <div>
                  <h1 className="text-lg md:text-xl font-bold text-white">Explorar Recursos</h1>
                  <p className="text-xs text-white/50 hidden sm:block">Apps y sitios para aprender mas</p>
                </div>
              </div>
            </div>
            <Badge className="bg-gradient-to-r from-cyan-500 to-violet-500 text-white border-0 text-xs">
              <Globe className="h-3 w-3 mr-1" />
              {externalResources.length} sitios
            </Badge>
          </div>
        </div>
      </header>
