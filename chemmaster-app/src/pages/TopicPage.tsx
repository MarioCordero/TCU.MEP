...
export default function TopicPage({ basePath = '' }: { basePath?: string }) {
  ...
  const contentType = detectContentType()
  const isAlreadyCompleted = gradeId && moduleId ? isTopicCompleted(gradeId, moduleId, topic.id) : false
  const moduleColor = module.color || 'from-gray-500 to-gray-400'
